...
{{--                                <img src="uploads/album_covers/{{$album->dis_img}}" alt="" class="card-img-top">--}}
{{--                            </a>--}}
{{--                            <div class="card-body">--}}
{{--                                <h5 class="card-title"> {{$album->dis_name}}--}}
{{--                                    <br>--}}
{{--                                    <br>--}}
{{--                                    <a href="#!" class="blue-text">--}}
{{--                                        <h6 class="font-weight-bold mb-3"><i class="fas fa-globe"></i> {{$album->dis_type}} </h6>--}}
{{--                                    </a>--}}
{{--                                </h5>--}}
{{--                                <p class="card-text"> {{$album->dis_body}} </p>--}}
{{--                            </div>--}}
{{--                            <br>--}}
{{--                            <a href="/show/{{$album->id}}" class="btn btn-outline-primary mr-1"><i class="fab fa-readme"></i></i> Read More </a>--}}
{{--                        </div>--}}
                        <div class="card-group">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="font-weight-bold mb-3">{{$album->dis_name}}</h4>
                                    <p>{{$album->dis_body}}</p>
                                    <a href="/show/{{$album->id}}" class="btn btn-outline-primary mr-1"><i class="fab fa-readme"></i></i> Read More </a>
                                </div>
                            </div>
